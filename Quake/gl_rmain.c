...
cvar_t	r_brightmodels_list = { "r_brightmodels_list", "progs/g_chaingun.mdl,progs/g_gauss.mdl,progs/g_grenade.mdl,progs/g_katana.mdl,progs/g_pistol.mdl,progs/g_shock.mdl,progs/g_shotgun.mdl,progs/g_smgs.mdl", CVAR_NONE };
...
cvar_t	r_healthmodels_list = { "r_healthmodels_list", "progs/health_s.mdl,progs/health_b.mdl,progs/health_m.mdl", CVAR_NONE };
cvar_t	r_armormodels_list = { "r_armormodels_list", "progs/armor.mdl,progs/sprawl_logo.mdl", CVAR_NONE };
