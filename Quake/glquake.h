...
typedef enum {
	pt_static, pt_bullet, pt_muzzle, pt_gauss, pt_gaussmain, pt_holegauss, pt_grav, pt_gaussexit, pt_slowgrav, pt_fire, pt_explode, pt_explode2, pt_blob, pt_blob2, pt_blood
} ptype_t;
